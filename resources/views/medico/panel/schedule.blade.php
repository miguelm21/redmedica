...
{{-- ///////////////////////////////////////////////////////CONTENIDO//////////////////// --}}
  ...
  @section('content')
<a href="{{route('medico_business_hours',$medico->id)}}">AAA</a>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header bg-primary" style="color:white">
        <h5 class="modal-title" id="exampleModalLabel">Agregar Horas de trabajo</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        {!!Form::open(['route'=>'medico_schedule_store','method'=>'POST'])!!}
        {!!Form::hidden('medico_id',$medico->id)!!}
        <div class="form-group">

          {!!Form::select('title',['1'=>'lunes','2'=>'martes','3'=>'miercoles','4'=>'jueves','5'=>'viernes','6'=>'sabado','0'=>'domingo'],null,['class'=>'form-control','id'=>'day'])!!}
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          <div class="form-inline">
          <label for="">Hora de Culminación</label>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header bg-primary">
          <h5 class="modal-title" id="exampleModalLabel" style="color:white">Editar Horas de Trabajo</h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
        <div class="modal-body">
          {!!Form::open(['route'=>'medico_business_hours_update','method'=>'POST'])!!}

          {!!Form::hidden('event_id',null,['id'=>'event_id2'])!!}
          {!!Form::hidden('medico_id',$medico->id)!!}
          <div class="form-group">
          ...
          <div class="form-group">
            <div class="form-inline">
            <label for="">Hora de Culminación</label>
              {!!Form::select('hourEnd',['--'=>'--','01'=>'01','02'=>'02','03'=>'03','04'=>'04','05'=>'05','06'=>'06','07'=>'07','08'=>'08','09'=>'09','10'=>'10','11'=>'11','12'=>'12','13'=>'13','14'=>'14','15'=>'15','16'=>'16','17'=>'17','18'=>'18','19'=>'19','20'=>'20','21'=>'21','22'=>'22','23'=>'23','24'=>'24'],null,['class'=>'form-control','id'=>'hourEndUp'])!!}
  ...
  <script type="text/javascript">
    ...
    // function calendario(){
      ...
      // },
        ...
        events: "{{route('medico_business_hours',$medico->id)}}",
        //   [
        //   {
        //     title: 'event1',
        //     start: '10:00',
        ...
        // horario de trabajo
        businessHours: "{{route('medico_business_hours',$medico->id)}}",
  // {
  //         start: '3:00',
  //         end: '6:00',
  //         dow: [1],
