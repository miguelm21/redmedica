          ...
          @endif
              ...
              <div id="list_service_ajax" style="text-align:justify">
							...
							<div class="row">
						  	...
						  	<div class="row mt-3">
								<div class="col-12">
									<h4 class="font-title-blue text-center">Experiencia en transtornos mentales</h4>
									<hr>
								</div>
							</div>
              ...
              <div class="row">
                <div class="col-4">
                  <a href="btn" class="btn btn-primary" id="facebook"><i class="fab fa-facebook-f mr-2"></i>Facebook</a>
                </div>
                <div class="col-4">
                  <a href="btn" class="btn btn-light" id="instagram"><i class="fab fa-instagram mr-2"></i>Instagram</a>
                </div>
                <div class="col-4">
                  <a href="btn" class="btn btn-danger" id="google"><i class="fab fa-google-plus-g mr-2"></i>Google+</a>
                </div>
              </div>
              <hr>
